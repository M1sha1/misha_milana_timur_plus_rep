...
print("Щоб пограти треба задонатити: Міші-5168 7520 #### 4667, Тімуру-1487 5242 1234 6767, Мілані-9254 4857 6484 5282. кожному по 500$")

vubir = input("n/d?")
if vubir == "n":
    print("ти не можеш зайти в гру поки не задонатите")
if vubir == "d":
    print("молодець тепер ти можеш пограти")
